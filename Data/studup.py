...
sql="update stud set SName='%s',Addr='%s',DOB='%s',DOJ='%s',CourseId='%s',FatherName='%s',MotherName='%s',Remarks='%s' where StudId='%s'" %(Sname,Addr,DOB,DOJ,CourseId,FatherName,MotherName,Remarks,StudId)
cursor.execute(sql)
db.commit()
