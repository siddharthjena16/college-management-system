...
DOP=form.getvalue('DOP')
Amount=form.getvalue('Amount')
FeesId=form.getvalue('FeesId')
sql="insert into feespaid values('%s','%s','%s','%s')" %(FeesId,DOP,StudId,Amount)
cursor.execute(sql)
db.commit()
cursor.close()
...
print "Await approval within 2-3 days. otherwise approach office"
...
print "<br><button type=submit formaction=feesub.py>Submit Fees</button>"
print "&nbsp;&nbsp;&nbsp;&nbsp;"
print "</center></form>"
